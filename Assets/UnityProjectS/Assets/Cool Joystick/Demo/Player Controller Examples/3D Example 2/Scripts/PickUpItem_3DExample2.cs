...
namespace CoolJoystick
{
	...
	/// </summary>
	public class PickUpItem_3DExample2 : MonoBehaviour
	{
		...
		private Player3DExample2 _playerController; // Player controller script

		private void Start ( )
		{
			if ( Player )
				_playerController = Player.GetComponent < Player3DExample2 > ( ); // Getting player controller script
		}
